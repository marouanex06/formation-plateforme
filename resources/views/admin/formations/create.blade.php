...
<head>
    ...
    <title>Créer formation - Admin</title>
        ...
        <form method="POST" action="{{ route('admin.formations.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <textarea name="short_desc_fr" rows="3"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('short_desc_fr') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Description courte EN</label>
                    <textarea name="short_desc_en" rows="3"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('short_desc_en') }}</textarea>
                </div>
            </div>

            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Description complète FR</label>
                    <textarea name="full_desc_fr" rows="5"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('full_desc_fr') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Description complète EN</label>
                    <textarea name="full_desc_en" rows="5"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('full_desc_en') }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="duration" value="{{ old('duration') }}" placeholder="ex: 3 jours"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">SEO Title FR</label>
